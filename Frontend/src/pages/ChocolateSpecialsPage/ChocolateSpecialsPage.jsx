...
const ChocolateSpecialsPage = ({ setShowCartSidebar, isLoggedIn, setShowLogin }) => {
    ...
    const fetchFoodItems = async () => {
      try {
        ...
        if (res.data.success) {
          ...
          // ✅ Filter only Chocolate Specials
          const chocolateNames = ["Ferrero Classic Cake", "Nutella Cake"];
          setFilteredItems(allItems.filter(item => chocolateNames.includes(item.name)));
        } else {
          Swal.fire({
            icon: "error",
...
export default ChocolateSpecialsPage;
