...
const CustomOrdersPage = ({ setShowCartSidebar, isLoggedIn, setShowLogin }) => {
    ...
    const fetchFoodItems = async () => {
      try {
        ...
        if (res.data.success) {
          ...
          const customNames = ["Salted Caramel Cake", "Red Velvet Cake"];
          setFilteredItems(allItems.filter(item => customNames.includes(item.name)));
        } else {
          Swal.fire({
            icon: "error",
